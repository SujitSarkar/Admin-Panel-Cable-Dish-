...
class PaidCustomerList extends StatefulWidget {
  @override
  _PaidCustomerListState createState() => _PaidCustomerListState();
}

class _PaidCustomerListState extends State<PaidCustomerList> {
  ...
  fetchAllCustomer() async {
    dynamic result = await DatabaseManager().getPaidCustomer();
